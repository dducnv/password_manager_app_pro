...
class Strings {
  //pages titles
  static String get homePageTitle => "home".tr();
  static String get passwordGeneratorTitle => "password_generator".tr();
  static String get settingsPageTitle => "settings".tr();
  ...
  static String get copyToClipboard => "copy_to_clipboard".tr();
  static String get copyPassword => "copy_password".tr();
